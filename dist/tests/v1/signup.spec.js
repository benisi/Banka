...
describe('Tests to create a user', function () {
  it('should return 201 success status code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.validUser).end(function (err, res) {
...
describe('Tests for empty email', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.emptyEmail).end(function (err, res) {
...
describe('Tests for undefined email', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.undefineEmail).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests if email exist', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.alreadyInUseUser).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for invalid email address', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.invalidEmail).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for dataType of email --string', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.nonStringEmail).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for empty first name', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.emptyFirstName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for undefined first name', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.undefineFirstName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for dataType of first name --string', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.nonStringFirstName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for invalid first name', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.invalidFirstName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for empty last name', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.emptyLastName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for undefined Last name', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.undefineLastName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for dataType of Last name --string', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.nonStringLastName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for invalid Last name', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.invalidLastName).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for invalid password', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.invalidPassword).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for invalid phone number', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.invalidPhoneNumber).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
...
describe('Tests for invalid sex', function () {
  it('should return 400 error code', function (done) {
    _chai["default"].request(_app["default"]).post(url).send(_users.invalidSex).end(function (err, res) {
      expect(res).to.have.status(400);
      res.body.should.be.a('object');
      expect(res.body).to.have.property('error');
