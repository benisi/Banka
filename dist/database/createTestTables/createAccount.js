...
function () {
  ...
  _createClass(AccountsTableHandler, null, [{
    ...
    value: function createTable() {
      var create = _dbTestConnection["default"].query(createAccountTable).then(function (result) {
        return console.log("AccountsTable: ".concat(result[0].command, ", ").concat(result[1].command));
