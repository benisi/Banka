...
function () {
  ...
  _createClass(TransactionsTableHandler, null, [{
    ...
    value: function createTable() {
      var create = _dbTestConnection["default"].query(createTransactionTable).then(function (result) {
        return console.log("transactions Table: ".concat(result[0].command, ", ").concat(result[1].command));
